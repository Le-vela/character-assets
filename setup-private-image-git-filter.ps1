...
$cleanCommand = "powershell -NoProfile -ExecutionPolicy Bypass -File '$filterScriptForGit' -Mode Clean"
$smudgeCommand = "powershell -NoProfile -ExecutionPolicy Bypass -File '$filterScriptForGit' -Mode Smudge"
